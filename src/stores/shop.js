...
export const useShopStore = defineStore('shop', {
  state: () => ({
    products: [
      ...
      { id: 2, name: 'Vòng đỏ dâu tây', color: 'do', price: 50000, stock: 0, img: '/img/vongdodautay.jpg' },
      { id: 3, name: 'Vòng bé mèo kẹo mút', color: 'trang', price: 300000, stock: 3, img: '/img/vongbemeokemut.jpg' }
    ],
    cart: []
  }),
  getters: {
